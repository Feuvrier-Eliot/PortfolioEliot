<template>
           ...
           <div class="pt-5 md:px-5 gap-5 md:gap-20 relative">
            <div class="grid grid-cols-1">
              <div class="md:pt-40 pt-20 animate__animated animate__backInDown">
                <div>
        <h1 class="text-white pl-8 md:pl-20 text-left font-rubik text-3xl md:text-7xl">OSAKA</h1>
  
  </div>
  
  <div class="md:pt-10 pt-5">
      <p class="md:pb-4 md:text-lg font-light pl-8 md:pl-20 text-white text-left font-rubik uppercase">Project realized in December, 2022</p>
    </div>
    </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 pt-12 md:pt-24 pl-16 md:pl-80">
      ...
      <img class="w-48 md:w-80 " src="/public/affiche_osaka.png">
      <p class="text-black pl-16 md:pl-24 pt-1 text-base font-rubik">Osaka poster</p>
      </div>
        <div class="pb-10 md:pb-20">
      <img class="w-48 md:w-80 " src="/public/Osaka.png">
      <p class="text-black pl-16 md:pl-24 pt-1 text-base font-rubik">Osaka Logo</p>
      </div>
      </div>
      <div class="md:pr-20">
      <p class="text-[#342A6A] text-2xl font-bold md:text-4xl pb-2 md:pb-5">PROJECT INFO</p>
      <p class="text-black text-base font-rubik pb-2 md:pb-5">The Osaka Project is a fictional project that was set up to promote the 2025 World Expo in Osaka. The work to be done was to create a poster and a postcard that would be used during the inauguration of the universal exhibition</p>
