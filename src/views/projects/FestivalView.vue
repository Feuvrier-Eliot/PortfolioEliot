         ...
         <div class="pt-5 md:px-5 gap-5 md:gap-20 relative">
          <div class="grid grid-cols-1">
            <div class="md:pt-40 pt-20 animate__animated animate__backInDown">
              <div>
      <h1 class="text-white pl-8 md:pl-20 text-left font-rubik text-3xl md:text-7xl">THE ELECTRO MOODS </h1>
      <h1 class="text-white pl-8 md:pl-20 text-left font-rubik text-3xl md:text-7xl">FESTIVALS</h1>
...
<div class="grid grid-cols-1 md:grid-cols-2 pt-12 md:pt-24 pl-16 md:pl-80">
    ...
    <img class="w-48 md:w-80 " src="/public/Festival.png">
    <p class="text-black pl-36 md:pl-64 pt-1 text-base font-rubik">Logo</p>
    </div>
    <div class="pb-10 md:pb-20">

    <img class="w-48 md:w-80" src="/public/MockupFestival.png">
    <p class="text-black pl-28 md:pl-64 pt-1 text-base font-rubik">Mock-up</p>
</div>
    </div>
    <div class="md:pr-20">
    <p class="text-[#342A6A] text-2xl font-bold md:text-4xl pb-2 md:pb-5">PROJECT INFO</p>
    <p class="text-black text-base font-rubik pb-2 md:pb-5">The "Electro Moods Festival" is a fictional college project designed to practice event skills. With its bold art direction featuring a black background contrasting with blue and white neon lights, it showcases the unique and innovative musical style that makes for an electrifying and memorable festival.</p>
    ...
    <p class="text-black text-base font-rubik pb-2 md:pb-5">Figma, Illustrator</p>
    <p class="text-[#342A6A] text-2xl font-bold md:text-4xl pb-2 md:pb-5">URL </p>
    <a href="http://electro-moods-festival.eliot-feuvrier.fr" class="text-black text-base font-rubik pb-">electro-moods-festival.eliot-feuvrier.fr</a>
</div>
  </div>
    </div>

    <section class="h-fit md:h-fit pt-10">
        <img src="/public/ElectroMoodsScreen.png" alt="">
    </section>  
     <Footer />
